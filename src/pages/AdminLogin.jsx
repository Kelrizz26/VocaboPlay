...
const AdminLogin = () => {
  ...
  const handleUserLogin = async (user) => {
    try {
      ...
      if (userRole === 'super_admin') {
        ...
        setError('Access denied. Teacher or Super Admin only.');
        setLoading(false);
        await auth.signOut();
        return;
      }
  ...
  const styles = {
    ...
    modalOverlay: {
      position: 'fixed',
      inset: 0,
      backgroundColor: 'rgba(45, 42, 94, 0.5)',
      display: 'flex',
      alignItems: 'center',
      justifyContent: 'center',
      zIndex: 2000,
        ...
        {`
          ...
          * { box-sizing: border-box; }
          ...
          @media (max-width: 768px) {
            .admin-card { padding: 24px 16px !important; max-width: 100% !important; }
            .admin-title { font-size: 24px !important; }
            .admin-subtitle { font-size: 13px !important; margin-bottom: 20px !important; }
            .admin-input { padding: 10px 14px !important; font-size: 14px !important; }
            .admin-btn { padding: 12px 20px !important; font-size: 14px !important; }
            ...
            .admin-nav { padding: 15px 20px !important; }
          ...
          @media (max-width: 480px) {
            .admin-card { padding: 20px 14px !important; }
      ...
      <div className="split-container">
        <div className="left-side">
          <div className="admin-card animate-slide-up" style={styles.card}>
            <h1 className="admin-title" style={styles.title}>Teacher Login</h1>
            <p className="admin-subtitle" style={styles.subtitle}>Access your class dashboard</p>
            ...
            <p style={styles.superAdminText}>
              ⭐ Super Admin?{' '}
              <a 
                onClick={() => !loading && navigate('/super-admin-login')} 
                style={{
                  ...styles.superAdminLink,
                  cursor: loading ? 'not-allowed' : 'pointer',
                  opacity: loading ? 0.5 : 1
                }}
        ...
        <div className="right-side animate-fade-in">
          ...
          <div style={styles.illustrationContainer}>
            ...
            <h2 style={styles.illustrationTitle}>Teacher control,</h2>
            <p style={styles.illustrationSubtitle}>manage your class with ease.</p>
          </div>
        </div>
      </div>
      ...
      {showForgotPassword && (
        <div style={styles.modalOverlay} onClick={() => setShowForgotPassword(false)}>
          <div style={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            ...
            {resetMessage && <div style={{...styles.errorMessage, backgroundColor: '#e8f5e9', borderColor: '#a5d6a7', color: '#2e7d32'}}>{resetMessage}</div>}
