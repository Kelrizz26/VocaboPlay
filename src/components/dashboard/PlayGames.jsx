...
const PlayGames = ({ startGame }) => {
  ...
  const categories = [
    { id: 'all', name: 'All Games', icon: '🎮', color: '#2D2A5E' },
    { id: 'vocab', name: 'Vocabulary', icon: '📚', color: '#F4A261' },
    { id: 'reading', name: 'Reading', icon: '📖', color: '#2A9D8F' },
    { id: 'challenge', name: 'Challenge', icon: '⚡', color: '#E76F51' },
  ];
  ...
  const getDifficultyColor = (difficulty) => {
    switch (difficulty) {
      case 'beginner': return '#8AB17D';
      case 'intermediate': return '#F4A261';
      case 'advanced': return '#E76F51';
      default: return '#5A587A';
    }
  };
    ...
    <div className="playgames-container" style={{
      ...
      <style>{`
        @media (max-width: 768px) {
          .playgames-container { padding: 20px 16px !important; }
          ...
          .playgames-categories button span:first-child { font-size: 12px !important; }
          ...
          .playgames-card { border-radius: 10px !important; }
          ...
          .playgames-footer-stats span { font-size: 12px !important; }
          .playgames-badge { padding: 2px 8px !important; font-size: 10px !important; }
        }
        @media (max-width: 480px) {
          .playgames-container { padding: 12px !important; }
          .playgames-header h1 { font-size: 18px !important; }
          .playgames-grid { grid-template-columns: 1fr !important; gap: 10px !important; }
          .playgames-card-image { height: 80px !important; }
          .playgames-card-content { padding: 12px !important; }
          .playgames-card-title { font-size: 14px !important; }
          .playgames-categories button { padding: 5px 10px !important; font-size: 11px !important; }
          .playgames-categories button span:first-child { font-size: 11px !important; }
        }
      `}</style>
      ...
      <div className="playgames-grid" style={{
        ...
        {filteredGames.map((game, index) => (
          <div
            ...
            style={{
              background: colors.surface,
              border: `2px solid ${hoveredGame === game.id && game.available ? game.accentColor : colors.border}`,
              borderRadius: '12px',
              overflow: 'hidden',
