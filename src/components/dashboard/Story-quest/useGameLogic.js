...
export const useGameLogic = ({ onBack, updateProgress }) => {
  ...
  // (synchronous — 100% guaranteed once lang save)
  // ============================================================
  ...
  // ============================================================
  // ===== SAVE TO FIREBASE — ✅ 1 correct = 1 point = 1 XP =====
  // ============================================================
  ...
  const updateDashboardProgress = useCallback(() => {
    ...
    if (hasSavedProgressRef.current) {
      console.log('⚠️ ShortStory: Dashboard progress already saved — skipping');
      return;
    }
    hasSavedProgressRef.current = true;

    if (!updateProgress) {
      console.log('⚠️ ShortStory: No updateProgress function provided');
      return;
    }

    const totalQuestions = totalAnswers || 0;
    ...
    updateProgress({
      ...
      totalPoints: pointsEarned,    // ✅ 1 correct = 1 point
      xp: pointsEarned,             // ✅ 1 correct = 1 XP (1:1)
      wordsLearned: correct,        // ✅ 1 correct = 1 word
  ...
  // ============================================================
  // ===== HANDLE CHOICE — ✅ 1 point, walang real-time save =====
  // ============================================================
        ...
        if (newLives === 0) {
          setTimeout(() => {
            if (isMountedRef.current) {
              ...
              updateDashboardProgress();  // ✅ IDINAGDAG
  ...
  }, [selectedChoice, lives, stopSpeaking, typeText, saveGameToFirebase, updateDashboardProgress, getLivesStorageKey]);
  ...
  const confirmExit = useCallback(() => {
    ...
    updateDashboardProgress();  // ✅ IDINAGDAG
    if (onBack) onBack();
  }, [onBack, stopSpeaking, saveGameToFirebase, updateDashboardProgress]);
  ...
  }, [timer, timerRunning, selectedChoice, lives, stopSpeaking, typeText, saveGameToFirebase, updateDashboardProgress, getLivesStorageKey]);
