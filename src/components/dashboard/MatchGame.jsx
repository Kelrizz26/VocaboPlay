...
const bgAnimationStyle = (
  <style>{`
    ...
    @media (max-width: 768px) {
      ...
      .match-game-header { padding: 8px 12px !important; margin-bottom: 8px !important; flex-wrap: wrap !important; gap: 4px !important; }
        ...
        <div className="match-game-intro" style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              🎯 {totalPairs} pairs • ⏱️ {timeLimit}s • +1 XP per match ✅
            </p>
