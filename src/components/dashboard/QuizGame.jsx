...
const QuizGame = ({ onBack, updateProgress }) => {
  ...
  // ============================================================
  // ===== SAVE TO FIREBASE — ✅ FIXED: 1 correct = 1 point =====
  // ============================================================
  ...
  // ============================================================
  // ===== HANDLE ANSWER — ✅ FIXED: 1 correct = 1 point =====
  // ============================================================
    ...
    if (!answered && current) {
      ...
      if (isCorrect) {
        ...
        if (currentProgress && updateProgress) {
          ...
          console.log(`📊 Quiz answer correct: +1 point, +1 XP, +1 word`);
        }
      } else {
        playWrong();
        setStreak(0);
  ...
  const handleExitGame = () => {
    ...
    if (gameState === 'playing' && score > 0 && !sessionSavedRef.current) {
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ background: 'rgba(255,255,255,0.04)', padding: '16px', borderRadius: '12px', textAlign: 'center' }}>
              <div style={{ fontSize: '24px', fontWeight: '700', color: '#5C6AC4' }}>+1</div>
